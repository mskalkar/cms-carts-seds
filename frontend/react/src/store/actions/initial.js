...
import fakeUserData from "../dummyData/fakeUserData";
import { getProgramData, getStateData, getUserData } from "../stateUser";

export const LOAD_SECTIONS = "LOAD SECTIONS";
export const QUESTION_ANSWERED = "QUESTION ANSWERED";

const temp__data = require("../dummyData/initial.json");
